...
CREATE SCHEMA IF NOT EXISTS `Proyecto_Spotify_test` DEFAULT CHARACTER SET utf8 ;
USE `Proyecto_Spotify_test` ;
...
CREATE TABLE `cancion` (
  ...
  `cantreproduccion` int(11) DEFAULT NULL,
...
CREATE TABLE `datospagoxusuario` (
  `idDatosPagoxUsuario` int(11) NOT NULL,
...
CREATE TABLE `generoxcancion` (
  `idGeneroxCancion` int(11) NOT NULL,
...
CREATE TABLE `playlist` (
  ...
  `idusuario` int(11) DEFAULT NULL,
  `titulo` varchar(45) DEFAULT NULL,
  `cantcanciones` int(11) DEFAULT NULL,
...
CREATE TABLE `playlistxcancion` (
  `idPlaylistxCancion` int(11) NOT NULL,
  `Idcancion` int(11) DEFAULT NULL,
